...
const UserModal = ({ open, onClose, userId }) => {
	...
	useEffect(() => {
        let isSubscribed = true;  // Declara a variável aqui dentro do useEffect
		...
		const fetchUser = async () => {
			...
			try {
                ...
                // Antes de atualizar o estado, verifica se ainda está "montado"
        ...
        // Cleanup do effect: se desmontar, seta isSubscribed = false
        return () => {
            isSubscribed = false;
        };
	}, [userId, open]);
